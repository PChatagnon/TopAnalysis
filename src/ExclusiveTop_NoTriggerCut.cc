...
//    }
    ...
    TString fvars[]={
        ...
        "nBjets", "nLightJets", "nJets", "minEtaJets" ,"maxEtaJets", "ht", "cat","sumPFPz","sumPFEn","sumPVChPz","sumPVChEn",
	...
	float min_eta = 5.0;	
	float max_eta = -5.0;
	for( size_t i_jets=0;i_jets<jets.size();i_jets++){

		float eta_jets = jets[i_jets].p4().Eta();
